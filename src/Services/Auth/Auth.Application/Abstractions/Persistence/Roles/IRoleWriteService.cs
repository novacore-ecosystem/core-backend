...
{
    /// <summary>
    /// Self-commits (bare SaveChangesAsync) - no caller-owned transaction exists yet.
    /// </summary>
    ...
    /// <summary>
    /// Replaces the Role's permission set wholesale with permissionKeys, via the
    ...
    /// known key not allowed for the Role provider throws.
    /// </summary>
    Task<RolePermissionUpdateResult> UpdatePermissionsAsync(
        Guid id,
