...
public interface IEffectivePermissionReadService
{
    ...
    /// <summary>
    /// Batched form of GetEffectivePermissionsAsync - one query for every accountId instead
    ...
    /// <summary>
    /// Every Account, within tenantId, currently holding roleId - directly (AccountRole)
    ...
    /// change (see docs/services/auth-service.md, Phase 3 - "Role-level change must propagate").
    /// </summary>
