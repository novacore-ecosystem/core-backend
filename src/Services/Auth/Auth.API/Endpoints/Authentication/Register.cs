...
public sealed class RegisterEndpoint : ICarterModule
{
    private readonly string[] API_DESC = [
        ...
        "",
        "### Response",
        "Creates the account with its email unconfirmed and requests a verification email - no",
        "access/refresh tokens are issued here. Login only succeeds once the email is confirmed.",
        "",
        "### Error Responses",
