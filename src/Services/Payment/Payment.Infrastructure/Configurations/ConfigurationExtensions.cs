...
using NovaCore.Payment.Infrastructure.Configurations.Validators;
...
namespace NovaCore.Payment.Infrastructure.Configurations;

/// <summary>Binds and validates every local <see cref="ISetting"/> in this assembly, then manually validates the external settings Payment depends on but doesn't own.</summary>
public static class ConfigurationExtensions
{
    public static IServiceCollection AddPaymentConfigurations(
