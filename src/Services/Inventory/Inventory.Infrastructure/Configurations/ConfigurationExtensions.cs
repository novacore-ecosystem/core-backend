...
using NovaCore.Inventory.Infrastructure.Configurations.Validators;
...
namespace NovaCore.Inventory.Infrastructure.Configurations;

/// <summary>Binds and validates every local <see cref="ISetting"/> in this assembly, then manually validates the external settings Inventory depends on but doesn't own.</summary>
public static class ConfigurationExtensions
{
    public static IServiceCollection AddInventoryConfigurations(
