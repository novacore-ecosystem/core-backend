...
/// <summary>Per-language override of a GiftProgram's Name/Description. Identity is ProgramId + LanguageCode (Phase 3.1 correction) - no surrogate Id.</summary>
public sealed class GiftProgramTranslation : BaseEntity, IAuditable, ITenantEntity
{
