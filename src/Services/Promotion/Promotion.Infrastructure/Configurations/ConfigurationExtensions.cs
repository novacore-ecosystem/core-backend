...
using NovaCore.Promotion.Infrastructure.Configurations.Validators;
...
namespace NovaCore.Promotion.Infrastructure.Configurations;

/// <summary>Binds and validates every local <see cref="ISetting"/> in this assembly, then manually validates the external settings Promotion depends on but doesn't own.</summary>
public static class ConfigurationExtensions
{
    public static IServiceCollection AddPromotionConfigurations(
