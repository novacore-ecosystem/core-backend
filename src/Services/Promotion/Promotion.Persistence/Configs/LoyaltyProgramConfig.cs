...
public sealed class LoyaltyProgramConfig : IEntityTypeConfiguration<LoyaltyProgram>
{
    public void Configure(EntityTypeBuilder<LoyaltyProgram> builder)
    {
        ...
        // Relationships
        // PointRules/PointPolicies/Accounts are all configured from the child entity's own
        // config (single source per relationship).
