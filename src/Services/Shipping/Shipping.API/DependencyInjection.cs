...
public static class DependencyInjection
{
    ...
    {
        ServiceTitle = "NovaCore Shipping Service",
        ServiceDescription = "Shipping & Logistics Execution Service API",
        SwaggerRoutePrefix = "/api/shipping",
        ContactUrl = "http://localhost:5110",
        SwaggerUiTitle = "Shipping Service",
