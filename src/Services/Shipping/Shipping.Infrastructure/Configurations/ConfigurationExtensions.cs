...
using NovaCore.Shipping.Infrastructure.Configurations.Validators;
...
namespace NovaCore.Shipping.Infrastructure.Configurations;

/// <summary>Binds and validates every local <see cref="ISetting"/> in this assembly, then manually validates the external settings Shipping depends on but doesn't own.</summary>
public static class ConfigurationExtensions
{
    public static IServiceCollection AddShippingConfigurations(
