...
using NovaCore.Order.Infrastructure.Configurations.Validators;
...
namespace NovaCore.Order.Infrastructure.Configurations;

/// <summary>Binds and validates every local <see cref="ISetting"/> in this assembly, then manually validates the external settings Order depends on but doesn't own.</summary>
public static class ConfigurationExtensions
{
    public static IServiceCollection AddOrderConfigurations(
