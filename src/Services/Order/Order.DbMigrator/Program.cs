...
// AddPersistence registers OrderDbContext (Npgsql + snake_case naming) plus outbox/inbox,
// repositories and saga reliability - the same wiring Order.API used to do inline. Order has no
// seeder class - only migrations run here.
...
// database itself - on a first-time deployment the API crashes at startup because order_hangfire_db
