...
/// <summary>
/// Mints a short-lived access token for a guest Contact, reusing the same JwtSettings (signing
/// key/issuer/audience) every service's AddJwtBearerAuthentication already validates against - a
/// guest connecting with this token is authenticated by the exact same pipeline a real user's Auth
...
/// </summary>
public sealed class GuestTokenGenerator(JwtSettings settings) : IGuestTokenGenerator
{
