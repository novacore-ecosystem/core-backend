...
{
    public const string Section = "Jobs:OutboxCleanup";
    ...
    /// <summary>Processed messages older than this are eligible for deletion. Never applies to unprocessed rows.</summary>
