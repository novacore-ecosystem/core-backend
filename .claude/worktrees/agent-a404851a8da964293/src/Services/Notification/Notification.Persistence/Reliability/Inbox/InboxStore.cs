...
namespace NovaCore.Notification.Persistence.Reliability.Inbox;

/// <summary>
/// Application-level adapter: delegates to the generic Mongo store, translating between the two
