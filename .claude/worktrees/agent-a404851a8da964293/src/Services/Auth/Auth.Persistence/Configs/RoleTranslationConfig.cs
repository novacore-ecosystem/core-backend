...
public sealed class RoleTranslationConfig : IEntityTypeConfiguration<RoleTranslation>
{
    public void Configure(EntityTypeBuilder<RoleTranslation> builder)
    {
        // Table
        builder.ToTable("role_translations");

        // Properties
        // Id doubles as the owning Role's Id (see RoleTranslation.Create) - one row per language,
